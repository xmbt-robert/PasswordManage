...
//                }
                ...
                logger.info("Send SMS Error! valCode[" + valCode + "] phone[" + phone + "] statusCode [" + result.get("statusCode") + "]  error_message["+result.get("statusMsg")+"]");
                return false;
     ...
     * @param mobile 手机号
     */
    public static boolean modifyUserMobile(String user, String mobile) {
        boolean isOk = false;
        LdapContext ctx = null;
        Hashtable env = LdapKit.getEnv();
        ...
        if (entry != null) {
            try {
                ...
                mods[0] = new ModificationItem(DirContext.REPLACE_ATTRIBUTE,
                        new BasicAttribute("mobile", mobile));
