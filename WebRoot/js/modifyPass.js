    ...
    function modifyPass(objval) {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if (obj[0] != "" && obj[0] != null) {
                    status = obj[0];
                    if (obj[0] == digital || obj[0] == digital1 || obj[0] == digital2) {  	//用户状态为标识为'512'的时候，即正常状态
...
$(function () {              //判断新密码和确认密码
    ...
    $('#newPass').blur(function () {
        ...
        var reg = /^[A-Z]{0,}[a-z]{1,}[0-9]{1,}[^a-zA-Z0-9]{1,}|[A-Z]{0,}[a-z]{1,}[^a-zA-Z0-9]{1,}[0-9]{1,}|[A-Z]{0,}[0-9]{1,}[a-z]{1,}[^a-zA-Z0-9]{1,}|[A-Z]{0,}[0-9]{1,}[^a-zA-Z0-9]{1,}[a-z]{1,}|[A-Z]{0,}[^a-zA-Z0-9]{1,}[a-z]{1,}[0-9]{1,}|[A-Z]{0,}[^a-zA-Z0-9]{1,}[0-9]{1,}[a-z]{1,}|[a-z]{0,}[A-Z]{1,}[0-9]{1,}[^a-zA-Z0-9]{1,}|[a-z]{0,}[A-Z]{1,}[^a-zA-Z0-9]{1,}[0-9]{1,}|[a-z]{0,}[0-9]{1,}[A-Z]{1,}[^a-zA-Z0-9]{1,}|[a-z]{0,}[0-9]{1,}[^a-zA-Z0-9]{1,}[A-Z]{1,}|[a-z]{0,}[^a-zA-Z0-9]{1,}[0-9]{1,}[A-Z]{1,}|[a-z]{0,}[^a-zA-Z0-9]{1,}[A-Z]{1,}[0-9]{1,}|[0-9]{0,}[A-Z]{1,}[a-z]{1,}[^a-zA-Z0-9]{1,}|[0-9]{0,}[A-Z]{1,}[^a-zA-Z0-9]{1,}[a-z]{1,}|[0-9]{0,}[a-z]{1,}[^a-zA-Z0-9]{1,}[A-Z]{1,}|[0-9]{0,}[a-z]{1,}[A-Z]{1,}[^a-zA-Z0-9]{1,}|[0-9]{0,}[^a-zA-Z0-9]{1,}[a-z]{1,}[A-Z]{1,}|[0-9]{0,}[^a-zA-Z0-9]{1,}[A-Z]{1,}[a-z]{1,}|[^a-zA-Z0-9]{0,}[A-Z]{1,}[a-z]{1,}[0-9]{1,}|[^a-zA-Z0-9]{0,}[A-Z]{1,}[0-9]{1,}[a-z]{1,}|[^a-zA-Z0-9]{0,}[a-z]{1,}[A-Z]{1,}[0-9]{1,}|[^a-zA-Z0-9]{0,}[a-z]{1,}[0-9]{1,}[A-Z]{1,}|[^a-zA-Z0-9]{0,}[0-9]{1,}[a-z]{1,}[A-Z]{1,}|[^a-zA-Z0-9]{0,}[0-9]{1,}[A-Z]{1,}[a-z]{1,}$/;
