...
<head>
    ...
    <script src="../js/jquery.min_1.7.2.js" type="text/javascript"></script>
    <script src="../js/input_form.js"></script>
    <script src="../js/resetPass.js" type="text/javascript"></script>
    <script src="../js/messageCode.js" type="text/javascript"></script>
...
<p class="window_title"><a class="close closedown" href="javascript:void(0)">×</a><img
        src="../images/window_icon02.png"/>重置密码</p>

<div class="window_main">
    <label id="message_error" class="window_tip window_error" style="display:none">该账号为禁止状态，无法重置密码!</label>
...
<input type="button" class="operate" id="reset" value="重置" /></div>
</body>
</html>
